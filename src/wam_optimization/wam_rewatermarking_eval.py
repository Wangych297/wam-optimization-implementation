...
def summarize(rows, out_dir):
    ...
    summary_path = out_dir / "wam_rewatermarking_summary.csv"
    ...
    overview_path = out_dir / "wam_rewatermarking_overview.csv"
...
def main() -> int:
    ...
    metrics_path = out_dir / "wam_rewatermarking_metrics.csv"
