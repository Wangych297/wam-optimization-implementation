...
def write_summaries(rows, out_dir):
    ...
    summary_path = out_dir / "wam_combined_dwsf_strength_summary.csv"
    ...
    overview_path = out_dir / "wam_combined_dwsf_strength_overview.csv"
...
def main() -> int:
    ...
    metrics_path = out_dir / "wam_combined_dwsf_strength_metrics.csv"
