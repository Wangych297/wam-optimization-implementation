...
def summarize(rows, out_dir):
    ...
    summary_path = out_dir / "wam_adaptive_region_select_summary.csv"
    ...
    overview_path = out_dir / "wam_adaptive_region_select_overview.csv"
...
def main() -> int:
    ...
    import wam_dwsf_area_sweep as base
    ...
    metrics_path = out_dir / "wam_adaptive_region_select_metrics.csv"
    with metrics_path.open("w", newline="", encoding="utf-8-sig") as f:
        writer = csv.DictWriter(f, fieldnames=fieldnames)
        writer.writeheader()
        writer.writerows(rows)

    regions_path = out_dir / "wam_adaptive_region_select_regions.csv"
