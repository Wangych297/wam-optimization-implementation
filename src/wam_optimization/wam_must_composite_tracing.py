...
def write_summaries(rows, out_dir):
    ...
    summary_path = out_dir / "wam_must_composite_tracing_summary.csv"
    ...
    overview_path = out_dir / "wam_must_composite_tracing_overview.csv"
...
def main() -> int:
                    ...
                    for attack_name, attacked in apply_composite_attacks(wm_composite):
                        ...
                        for source_info in boxes:
                            ...
                            decoded_items = [
                                ...
                                ("must_mer_resize", crop.resize((args.material_size, args.material_size), RESAMPLE), None),
                            ]
    ...
    metrics_path = out_dir / "wam_must_composite_tracing_metrics.csv"
