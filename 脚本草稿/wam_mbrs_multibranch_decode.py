...
def main() -> int:
        ...
        for image_path in image_paths:
            ...
            for attack_name, attack_fn in attacks:
                ...
                methods = [
                    ...
                    ("mbrs_confidence_select", confidence_best),
                    ("mbrs_similarity_select", similarity_best),
    ...
    branch_path = out_dir / "wam_mbrs_multibranch_candidates.csv"
