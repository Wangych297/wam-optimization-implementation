...
def write_summary(rows, out_dir):
    ...
    summary_path = out_dir / "wam_trustmark_strength_summary.csv"
    ...
    overview_path = out_dir / "wam_trustmark_strength_overview.csv"
...
def main() -> int:
    ...
    metrics_path = out_dir / "wam_trustmark_strength_metrics.csv"
