...
def main() -> int:
    ...
    with torch.inference_mode():
        for image_path in image_paths:
            ...
            for attack_name, attack_fn in attacks:
                for scheme, img_w in (("single_center_50pct", baseline_img), ("dwsf_5region_spatial", dwsf_img)):
    ...
    metrics_path = out_dir / "wam_dwsf_spatial_v2_metrics.csv"
    ...
    summary_path = out_dir / "wam_dwsf_spatial_v2_summary.csv"
