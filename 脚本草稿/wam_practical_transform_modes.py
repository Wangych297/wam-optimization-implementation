...
def mode_definitions():
    return [
        ...
        {
            "scheme": "dwsf_default_q30_s2.5",
            "region_strategy": "dwsf_fixed_anchors",
            "area_percent": 30.0,
            "block_count": 5,
            "scaling_w": 2.5,
        },
        {
            "scheme": "dwsf_robust_q50_s2.5",
            "region_strategy": "dwsf_fixed_anchors",
            "area_percent": 50.0,
            "block_count": 5,
            "scaling_w": 2.5,
        ...
        {
            "scheme": "dwsf_robust_strong_q50_s3.0",
            "region_strategy": "dwsf_fixed_anchors",
            "area_percent": 50.0,
            "block_count": 5,
            "scaling_w": 3.0,
...
def build_mode_image(mode, img_pt, embedded_full, area):
    ...
    elif mode["region_strategy"] == "dwsf_fixed_anchors":
        masks = area.dwsf_area_masks(img_pt, mode["area_percent"], mode["block_count"])
...
def write_summaries(rows, out_dir, attack_order):
    ...
    summary_path = out_dir / "wam_practical_transform_modes_summary.csv"
    ...
    overview_path = out_dir / "wam_practical_transform_modes_overview.csv"
...
def main() -> int:
    ...
    metrics_path = out_dir / "wam_practical_transform_modes_metrics.csv"
