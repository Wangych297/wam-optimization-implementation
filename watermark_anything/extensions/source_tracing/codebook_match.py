...
def main() -> int:
    ...
    detail_path = out_dir / "source_tracing_codebook_match_metrics.csv"
    ...
    summary_path = out_dir / "source_tracing_codebook_match_summary.csv"
    ...
    overview_path = out_dir / "source_tracing_codebook_match_overview.csv"
