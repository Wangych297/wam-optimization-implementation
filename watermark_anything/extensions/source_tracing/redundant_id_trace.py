...
def write_summaries(rows, out_dir):
    ...
    summary_path = out_dir / "source_tracing_redundant_id_summary.csv"
    ...
    overview_path = out_dir / "source_tracing_redundant_id_overview.csv"
...
def main() -> int:
    ...
    from watermark_anything.extensions.source_tracing import composite_trace as base
                        ...
                        for attack_name, attacked in base.apply_composite_attacks(wm_composite):
                            ...
                            for source_info in boxes:
                                ...
                                decoded_items = [
                                    ...
                                    ("localized_resize", crop.resize((args.material_size, args.material_size), base.RESAMPLE), None),
                                ]
    ...
    metrics_path = out_dir / "source_tracing_redundant_id_metrics.csv"
