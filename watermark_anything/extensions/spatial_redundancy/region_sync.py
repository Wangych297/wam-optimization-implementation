...
def summarize(rows, out_dir):
    ...
    summary_path = out_dir / "region_sync_summary.csv"
...
def main() -> int:
    ...
    with torch.inference_mode():
        ...
        for scale in args.scales:
            ...
            for image_name, img_pt in cached_inputs:
                ...
                for scheme, img_w in (("single_center_50pct", base_img), ("five_region_spatial", distributed_img)):
    ...
    candidates_path = out_dir / "region_sync_candidates.csv"
    with candidates_path.open("w", newline="", encoding="utf-8-sig") as f:
        writer = csv.DictWriter(f, fieldnames=candidate_fields)
        writer.writeheader()
        writer.writerows(candidate_rows)

    methods_path = out_dir / "region_sync_methods.csv"
