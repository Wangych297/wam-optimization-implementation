...
def main() -> int:
    ...
    with torch.inference_mode():
        for image_path in image_paths:
            ...
            for attack_name, spec in attacks:
                for scheme, img_w in (("baseline_single_region", baseline_img), ("redundant_regions", redundant_img)):
    ...
    metrics_path = out_dir / "redundant_regions_metrics.csv"
    ...
    summary_path = out_dir / "redundant_regions_summary.csv"
