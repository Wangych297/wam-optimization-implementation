...
def summarize(rows, out_dir):
    ...
    summary_path = out_dir / "coding_variants_summary.csv"
    ...
    overview_path = out_dir / "coding_variants_overview.csv"
...
def main() -> int:
    ...
    from watermark_anything.extensions.payload_coding import repetition_payload as ecc_base
    ...
    with torch.inference_mode():
        ...
        for coding, encoder, decoder in coding_specs:
            ...
            for image_name, img_pt in cached_inputs:
                ...
                mask_union = area.union_masks(area.distributed_area_masks(img_pt, args.area, args.block_count))
                distributed_img = embedded_full * mask_union + img_pt * (1 - mask_union)
    ...
    metrics_path = out_dir / "coding_variants_metrics.csv"
